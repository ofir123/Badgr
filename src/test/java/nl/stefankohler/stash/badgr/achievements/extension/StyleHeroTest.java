...
import nl.stefankohler.stash.badgr.achievements.extension.StyleHero;
...
public class StyleHeroTest {

    private StyleHero achievement;
    private Path path;
    ...
    public void testCountingLimit() {
        assertTrue(achievement.getCountingLimit().equals(152));
    }
}
